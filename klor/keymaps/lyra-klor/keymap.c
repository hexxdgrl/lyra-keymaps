...
#define GUI_C MT(MOD_LGUI, KC_A)
#define ALT_I MT(MOD_LALT, KC_R)
#define CTL_E MT(MOD_LCTL, KC_S)
#define SHT_A MT(MOD_LSFT, KC_T)

// RIGHT HAND HOME ROW MODS ├───────────────────────────────────┐

#define SHT_H MT(MOD_RSFT, KC_N)
#define CTL_T MT(MOD_LCTL, KC_E)
#define ALT_S MT(MOD_LALT, KC_I)
#define GUI_N@ MT(MOD_LGUI, KC_O)
 ...
 /*
   ...
   [_BASE] = LAYOUT_polydactyl(
       ...
       KC_HASH,    KC_G,        KC_X,        KC_J,           KC_K,         KC_MINS,                        KC_UNDS,        KC_R,        KC_M,        KC_F,        KC_P,        KC_SLASH,
                                LT(3, KC_ESC),LT(1, KC_SPC),LT(2, KC_TAB), KC_AT,                          KC_GRV,         LT(2, KC_ENT),  LT(1, KC_BSPC),LT(3, KC_DEL)
 ),
